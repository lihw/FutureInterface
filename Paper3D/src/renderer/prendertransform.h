...
public:
    ...
    P_INLINE const PMatrix4x4 &worldMatrix() const { return m_drawable->worldTransform(); }
    P_INLINE const PMatrix4x4 &cameraMatrix() const { return m_camera->cameraTransform(); }
    P_INLINE const PMatrix4x4 &projectionMatrix() const { return m_camera->projection().toMatrix4x4(); }
    PMatrix4x4 mvp() const;
