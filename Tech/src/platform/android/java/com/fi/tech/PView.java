...
/* TODO: ES1 handling is some smart way, e.g. reflection. Now it won't work because of api levels. */
...
public class PView extends GLSurfaceView {
    private static final String TAG = "PView";
    ...
    public PView(Activity activity, String contextName) {
        this(activity, true, false, contextName);
    }
     ...
     * @param translucent
     */
    public PView(Activity activity, boolean antialias, boolean translucent,
            String contextName) {
        super(activity);
        ...
        setEGLConfigChooser(new ConfigChooser(antialias, translucent));
    ...
    private static class ConfigChooser implements
        GLSurfaceView.EGLConfigChooser {
             ...
             * @param antialias
             */
            public ConfigChooser(boolean antialias, boolean translucent) {
